...
# EVENT
event1 = Event.create!(title: "La momia", description: "Description 1", event_flag: false, user_id: user3.id, private: true, resource_id: resource2.id, location: "new york", date: DateTime.new(2020, 4, 20, 4, 30))
event2 = Event.create!(title: "Busqueda del tesoro", description: "description2", event_flag: false, user_id: user2.id, private: true, resource_id: resource4.id, location: "Alabama", date: DateTime.new(2020, 4, 20, 4, 30))
event3 = Event.create!(title: "Tarzan", description: "Description 3", event_flag: false, user_id: user3.id, private: true, resource_id: resource2.id, location: "San Francisco", date: DateTime.new(2020, 4, 20, 4, 30))
...
event5 = Event.create!(title: "Tiburon", description: "description 5", event_flag: false, user_id: user3.id, private: true, resource_id: resource2.id, location: "Lake Tahoe", date: DateTime.new(2020, 4, 20, 4, 30))
...
# COMMENT
comment1 = Comment.create!(user_id: user1.id, comment: "nice event", event_id: event1.id)
comment2 = Comment.create!(user_id: user2.id, comment: "hi this is a super text", event_id: event1.id)
comment3 = Comment.create!(user_id: user3.id, comment: "Good Bye", event_id: event2.id)

# COMMENT_REPLY
comment_reply2 = CommentReply.create!(user_id: user2.id, comment_rep: "hi my name is ah my name is ah", comment_id: comment2.id)
comment_reply1 = CommentReply.create!(user_id: user1.id, comment_rep: "this is a text", comment_id: comment1.id)
